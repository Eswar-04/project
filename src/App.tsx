  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h2 className="text-xl mb-6 text-center font-medium text-slate-200">
              Live Camera Feed with AR Glasses
            </h2>
            <ARCamera className="mb-8" />
          </div>
        ...
        <div className="mt-8 bg-slate-800/50 backdrop-blur-sm p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
          ...
          <ul className="space-y-2 text-slate-300 text-sm">
            ...
            <li className="flex items-start gap-2">
              ...
              Use the 3D model viewer to examine the glasses from all angles.
            </li>
            <li className="flex items-start gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <footer className="mt-auto py-6 text-center text-sm text-slate-400">
        © 2025 AR Glasses Viewer | Created with React, TypeScript, and Three.js
      </footer>
    </div>
  );
}
